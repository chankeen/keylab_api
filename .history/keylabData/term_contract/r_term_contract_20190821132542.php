...
$sql_statment = "select *,DATEDIFF(contract_end_date,CURATE()),b.name_zh as buyer_name_zh AS end_day_diff from keylab_property_term_contract as a left join keylab_users as b on a.buyer_user_id on b.user_id";
$where = " where ";
