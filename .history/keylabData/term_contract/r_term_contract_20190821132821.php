...
$sql_statment = "select *,DATEDIFF(contract_end_date,CURATE()) AS end_day_diff ,b.name_zh as buyer_name_zh from keylab_property_term_contract as a left join keylab_users as b on a.buyer_user_id = b.user_id";
$where = " where ";
