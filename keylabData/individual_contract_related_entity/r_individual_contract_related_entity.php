...
$sql_statment = "SELECT main.*,users.name_zh,users.name_en,users.login_tel FROM `keylab_property_individual_contract_related_entity` as main
...
if (!empty($individual_contract_id)){
    $where = $where."main.individual_contract_id = ".$individual_contract_id." and ";
}
