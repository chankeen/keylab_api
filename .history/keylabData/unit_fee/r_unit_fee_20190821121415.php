...
$sql_statment = "select * from keylab_property_unit_fee as a left_join keylab_property_unit_list as b on a.unit_id = b.unit_id left join keylab_property as c on c.property_id = b.property_id";
$where = " where ";
